...
let carSpeed = load('carSpeed', 1); // מקדם מהירות עבודה

const stocks = [{id:'AAPL', n:'Apple', p:650}, {id:'TSLA', n:'Tesla', p:820}, {id:'NVDA', n:'Nvidia', p:450}, {id:'BTC', n:'Bitcoin', p:240000}];

function save() {
    const data = { money, bank, passive, loan, lastGift, theme, skills, inventory, totalEarned, totalSpent, invOwned, activeTasks, cars, carSpeed };
